...
<body>
    ...
    <div class="ts container">
        ...
        <div class="ts breadcrumb">
            <a href="<?php echo $returnPath;?>" class="section">ArOZβ Files</a>
        ...
        <div class="ts grid">
            <div class="eleven wide column">
				<div id="folderList" class="ts selection segmented list">
                ...
                <div id="fileList" class="ts selection segmented list">
            ...
            <div class="five wide column" style="position:fixed;right:5px;">
                <div class="ts card">
                    ...
                    <div class="extra content">
						...
						<a href="<?php echo $returnPath;?>" class="ts basic primary fluid button">Done</a>
                    </div>
                </div>
                <div class="ts horizontal right floated middoted link list">
                    <a class="item" onClick="UpdateFileList(currentPath);">Refresh</a>
                    <a href="<?php echo $returnPath;?>" class="item">Cancel</a>
	...
	function AppendControls(){
		...
		$('#folderList').append('<div id="controls" class="item">' + controlsTemplate + '</div>');
	}
	
	function LoadingErrorTest(){
		if ($('#fileList').html().includes("<br><br><br><br><br><br><div")){
			//Something went wrong while loading the page
			$('#fileList').html('<br><br><br><br><br><br><div class="ts active inverted dimmer"><div class="ts text loader">Seems something went wrong.<br>Try <a href="">refreshing</a> the page?</div></div>');
		}
	}
	
	function UpdateFileList(directory){
		setTimeout(LoadingErrorTest,15000);
		$('#fileList').html('<br><br><br><br><br><br><div class="ts active inverted dimmer"><div class="ts text loader">Loading...</div></div>');
		$('#folderList').html("");
		lastClicked = -1;
		$.ajax({
		...
		if (lastClicked != -1){
			if (lastClicked < dirs.length){
				...
				if (ext == "mp3"){
					...
					window.open("../../../Audio/?share=" + file + "&display=" + filename + "&id=-1 "); 
				}else if (ext == "mp4"){
					//Open with Video Module
					window.open("../../../Video/vidPlay.php?src=" + file); 
