...
<div id="dataGraph" class="ts narrow container" >
	<iframe src="system_statistic/loadGraph.php" width="100%;" style="height:150px;" scrolling="no"></iframe>
	<iframe src="system_statistic/ramGraph.php" width="100%;" style="height:150px;" scrolling="no"></iframe>
</div>
...
function updateProcessList(){
	if (enableProcess){
	$.ajax({
	  url: "system_statistic/listProcess.php?mode=json",
	}).done(function(data) {
