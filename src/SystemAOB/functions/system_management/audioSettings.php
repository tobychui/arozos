...
<html>
    <head>
    	...
    	<script src="ao_module.js"></script>
    	<style>
    	    body{
    ...
    <body>
        ...
        <div class="ts container">
            ...
            <div style="display:none;">
                <audio id="both" controls><source src="track/both.mp3" type="audio/mp3"></audio>
                <audio id="left" controls><source src="track/left.mp3" type="audio/mp3"></audio>
                <audio id="right" controls><source src="track/right.mp3" type="audio/mp3"></audio>
            </div>
        </div>
        <script>
