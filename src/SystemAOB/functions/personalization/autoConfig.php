    ...
    <body>
        ...
        <div class="ts container">
            <div class="ts segment">
                <div class="ts header">
                    <i class="edit icon"></i><?php echo strtoupper(strip_tags($_GET['configName'])) . " Configuration"?>
                <div class="sub header">Settings loaded by ArOZ System Configuration Engine</div>
            </div>
        </div>
        <div class="ts segment">
		...
		?>
        <div class="ts segment">
            <p><i class="setting icon"></i>ArOZ Online System Automatic Configuration Generator. <br>
                WARNING! These settings are for professionals and developers who knows what they are doing. 
                Incorrect settings might lead to system corruption or bring damage to the data contained in the system. 
                Please modify the settings at your own risk.</p>
        </div>
        <script>
            var focusedInput = "";
